...
Example usage:
    ...
    python3 scripts/calc_kv_compression.py \
        --model meta-llama/Meta-Llama-3-8B-Instruct \
        --seqlen 65536 --bits 16 --rank_k 96 --rank_v 0 --group-sizes 1,2,4

    python3 scripts/calc_kv_compression.py \
        --model meta-llama/Meta-Llama-3-8B-Instruct \
        --seqlen 65536 --bits 16 --rank_k 128 --rank_v 0 --group-sizes 1,2,4

    python3 scripts/calc_kv_compression.py \
        --model meta-llama/Meta-Llama-3-8B-Instruct \
        --seqlen 65536 --bits 16 --rank_k 160 --rank_v 0 --group-sizes 1,2,4
"""
