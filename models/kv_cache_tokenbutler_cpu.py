################################################################################
#
# TokenButler KV Cache with CPU Offloading
# 
# This module implements TokenButlerCache_CPU which stores the main K/V cache
...
class TokenButlerCache_CPU(CPUOffloadCacheBase):
    """
    KV Cache with TokenButler-based sparse attention and CPU offloading.
    ...
    def print_stats(self):
        print(f"TokenButlerCache_CPU | sparse_budget {self.sparse_budget} | producer_freq {self.producer_frequency} | dDash {self.dDash} | cached {self.kv_offset} | CPU offload enabled")
    ...
    def get_svd(self, key_states: torch.Tensor, layer_idx: int, fake_svd: bool = False):
        """No-op for TokenButlerCache. Kept for API compatibility."""
        pass
