...
def monkey_patch_keysifter_for_profiling(llm, profiler):
    """
    Enable profiling instrumentation in KeySifterCache.
    
    This is the DRY approach: the production KeySifterCache code already has
    profiling hooks using self._record(). We just need to set the profiler.
    """
