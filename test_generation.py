...
if __name__ == '__main__':
    ...
    variant_flags = [
        getattr(args, "tokenbutler", False),
        getattr(args, "tokenbutler_slice", False),
        getattr(args, "tokenbutler_project", False),
    ]
    ...
    if getattr(args, "tokenbutler_slice", False):
        args.tokenbutler_variant = "tokenbutler_slice"
    elif getattr(args, "tokenbutler_project", False):
        args.tokenbutler_variant = "tokenbutler_project"
    else:
        # Default: original predictor behaviour.
    ...
    question = question[:int(2 * len(question)/3)]
    ...
    load_path = args.predictor_ckpt or args.model_load_path
