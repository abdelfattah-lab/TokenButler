...
mkdir -p logs/sweep_60k
mkdir -p logs/results

echo "========================================"
echo "Starting Batch Size Sweep for 60k"
echo "========================================"
echo ""
...
for BSZ in "${BATCH_SIZES[@]}"; do
    ...
    python test/e2e.py \
        ...
        2>&1 | tee -a logs/sweep_60k/xkv_k${XKV_RANK_K}_v${XKV_RANK_V}_g${GROUP_SIZE}_bs${BSZ}.log
    ...
    #     --num_rounds $NUM_ROUNDS \
    #     --baseline \
    #     2>&1 | tee -a logs/sweep_60k/baseline_bs${BSZ}.log
    ...
    python test/e2e.py \
        ...
        2>&1 | tee -a logs/sweep_60k/shadowkv_k${SHADOWKV_RANK_K}_bs${BSZ}.log
    ...
    python test/e2e.py \
        ...
        --rank_v $XKV_RANK_V \
        --group_size $GROUP_SIZE \
        2>&1 | tee -a logs/sweep_60k/xkey_k${XKV_RANK_K}_v${XKV_RANK_V}_g${GROUP_SIZE}_bs${BSZ}.log
...
echo "========================================"
echo ""
echo "Results saved in logs/sweep_60k/ and logs/results/"
echo ""
